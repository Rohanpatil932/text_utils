...
export default function Navbar(props) {
  return (
    <>
<nav className={`navbar navbar-expand-lg navbar-${(props.mode,props.bmode)} bg-${(props.mode,props.bmode)}`}>
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className={`form-check form-switch mx-2 text-${props.bmode==='light'?'dark':'light'}`}>
